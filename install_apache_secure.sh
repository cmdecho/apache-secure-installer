...
body{margin:0;font-family:Inter,Arial;background:#020617;color:#e5e7eb;display:flex}
...
.card{background:#020617;border:1px solid #1e293b;border-radius:12px;padding:20px;margin-bottom:20px}
button,input{padding:12px;width:100%;margin-top:10px;border-radius:8px;border:1px solid #1e293b;background:#020617;color:white}
button{background:#38bdf8;color:black;font-weight:bold}
pre{background:black;padding:15px;border-radius:10px;overflow:auto}
EOF
...
<?php require "security.php"; ?>  <!DOCTYPE html><html><head>  <title>Dashboard</title>  
...
<?php require "security.php"; ?>  <!DOCTYPE html><html><head>  <title>Root Actions</title>  
<link rel="stylesheet" href="assets/style.css"></head>  
<body>  
<div class="sidebar">  
<h2>Root Action</h2>  
...
<?php session_destroy();header("Location: login.php"); ?>  EOF
